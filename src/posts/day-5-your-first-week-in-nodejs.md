...
![create project](/images/SUhXqX_0a-1024x385.png 'create-project')

**Create a new project**

![save project](/images/wCpF9djRm-1024x517.png 'save-project')

**Save project with members (default is logged-in user)**

![create database](/images/GjWoGMegW-1024x455.png 'create-db')

**Create your first database**

![select plan](/images/Es-Go-hMJ-1024x774.png 'select-plan')

**Select free plan**

Once you create your cluster, it will take some time for the initial deployment.

![create a database user](/images/lm898S-_05-1024x831.png 'create-db-user')
